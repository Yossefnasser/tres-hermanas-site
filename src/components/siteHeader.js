...
export function siteHeader() {
  ...
  <header class="fixed top-0 left-0 right-0 z-50">
    ...
    <div data-variant="desktop" class="bg-surface/95 backdrop-blur-md shadow-[0_1px_8px_rgba(0,0,0,0.03)]">
      <div class="bg-on-surface text-surface py-space-xs px-gutter text-center">
        <p class="font-label-sm text-label-sm uppercase tracking-[0.2em]">COMPLIMENTARY WORLDWIDE INSURED COURIER ON ALL 18KT FINE JEWELLERY ORDERS</p>
      </div>
    ...
    <div data-variant="mobile" class="bg-surface/90 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.04)]">
      ...
      <div class="bg-surface-container-high text-on-tertiary-container text-center py-1.5 px-margin-mobile flex items-center justify-center">
        <span class="font-label-sm text-label-sm tracking-[0.18em] uppercase text-tertiary">COMPLIMENTARY INSURED SHIPPING ON FINE HEIRLOOMS</span>
      </div>
      <div class="h-16 px-margin-mobile flex items-center justify-between gap-space-sm">
        ...
        <div class="flex items-center gap-1">
          ...
          <a aria-label="Wishlist" class="w-11 h-11 flex items-center justify-center text-on-surface hover:text-primary transition-colors" data-path="saved" href="#">
